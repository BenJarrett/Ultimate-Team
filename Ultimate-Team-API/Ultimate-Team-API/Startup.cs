        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
                .AddJwtBearer(options =>
                {
                    ...
                    options.Authority = "https://securetoken.google.com/ultimate-team-8034b";
                    options.TokenValidationParameters = new TokenValidationParameters
                    {
                        ValidateLifetime = true,
                        ValidateAudience = true,
                        ValidateIssuer = true,
                        ValidAudience = "ultimate-team-8034b",
                        ValidIssuer = "https://securetoken.google.com/ultimate-team-8034b"
                    };
                });
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Ultimate_Team_API", Version = "v1" });
            });
        }
